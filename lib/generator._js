...
function generateAspNetCoreMSBuild17DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateAspNetCoreMSBuild17DeploymentScript(_);
}
...
function generateDotNetConsoleMSBuild17DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateDotNetConsoleMSBuild17DeploymentScript(_);
}
...
function generateFunctionAppMSBuild17DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateFunctionAppMSBuild17DeploymentScript(_);
}
...
ScriptGenerator.prototype.generateFunctionAppMSBuild17DeploymentScript = function (_) {
  ...
  options.projectPath = fixPathSeparatorToWindows(this.projectPath);
  this.generateFunctionAppScript('function.msbuild17.template', options, _);
};
...
ScriptGenerator.prototype.generateAspNetCoreMSBuild17DeploymentScript = function (_) {
  log.info('Generating deployment script for ASP.NET MSBuild17 App');

  options = {}
  options.projectPath = fixPathSeparatorToWindows(this.projectPath);
  this.generateAspNetCoreMSBuild16AppScript('aspnet.core.msbuild17.template', options, _);
};
...
ScriptGenerator.prototype.generateDotNetConsoleMSBuild17DeploymentScript = function (_) {
  argNotNull(this.projectPath, 'projectPath');
  ...
  this.generateDotNetDeploymentScript('dotnetconsole.msbuild17.template', options, _);
};
